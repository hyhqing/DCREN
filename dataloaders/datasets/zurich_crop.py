...
class Segmentation(Dataset):
    ...
    def __init__(self,
                 args,
                 base_dir=Path.db_root_dir('zurich'),
                 split='train',
                 ):
        """
    ...
    def __getitem__(self, index):
        _img, _target, _target1, _connect0, _connect1, _connect2, _connect_d1_0, _connect_d1_1, _connect_d1_2 = self._make_img_gt_point_pair(index)
        sample = {'image': _img, 'label': _target, 'label1': _target1, 'connect0': _connect0, 'connect1': _connect1, 'connect2': _connect2,
    ...
    def _make_img_gt_point_pair(self, index):
        ...
        _target1 = Image.open(self.categories1[index])
        ...
        return _img, _target, _target1, _connect0, _connect1, _connect2, _connect_d1_0, _connect_d1_1, _connect_d1_2
...
if __name__ == '__main__':
    ...
    for ii, sample in enumerate(dataloader):
        for jj in range(sample["image"].size()[0]):
            ...
            segmap = decode_segmap(tmp, dataset='zurich')
            segmap1 = decode_segmap(tmp1, dataset='zurich')
